...
<body>
    ...
    <div class="offcanvas-menu-wrapper">
        ...
        <div class="offcanvas__logo">
            <a href="/home"><img src="images/logo/henry-logo.jpeg" height="50px" width="98px" alt="logo"></a>
        </div>
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-2">
                    <div class="header__logo">
                        <a href="{{ route('home') }}"><img src="images/logo/henry-logo.jpeg" height="50px" width="98px" alt="logo"></a>
                    </div>
                </div>
